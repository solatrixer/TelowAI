...
import Widgets from './Instance/Widgets/Widgets';
      ...
      {!delinquent ? (
        ...
        >
          ...
          {instances && instances?.length > 0 && selectedInstance ? (
            <>
              <GridItem
                colSpan={{ base: 24, md: selectedInstance ? 12 : 17 }}
                pl={0}
              >
                <Routes>
              ...
              >
                {instances && instances?.length > 0 && selectedInstance && (
                  <Widgets instance={selectedInstance} />
                )}
              </GridItem>
            </>
          ) : (
