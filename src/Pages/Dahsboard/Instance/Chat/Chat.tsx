        ...
        <MainContainer className="main-container">
          <ChatContainer>
            ...
            >
              ...
              >
                <Avatar size="sm" src={TelowLogoGreen} name="Telow" />
                ...
                messages.map((message: MessageModel) => {
                  return (
                    ...
                    >
                      ...
                      <Message.Footer>
                        {message.sentTime
                          ? moment(Number(message.sentTime)).fromNow()
                          : 'just now'}
                        <Box ml={2}>
                          {message.sender !== user?.id && 'Telow'}
                        </Box>
                      </Message.Footer>
                    </Message>
                  );
            ...
            <MessageInput
              ...
              placeholder={`Hi ${user?.given_name}, How can I help you in regard to ${instance!.domain}?`}
              onSend={handleSend}
            />
          </ChatContainer>
          <Button
